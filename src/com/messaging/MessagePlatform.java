...
/**
 * @author pg class MessagePlatform The main starting point of the MessagePlatform. This instantiates the main message
 *         queue, the consumer/producer thread for the base, and the consumer/producer thread for the UI. The
 *         implementing UI framework can hook into the consumer/producer UI thread to send/receive messages from the
 *         MessagePlatform.
 */
public class MessagePlatform {
    ...
    /**
     * Constructor intializes the queue and the consumer threads
     * 
    ...
    public MessagePlatform() {
        ...
        baseMessageManager = new BaseMessageManager(theMessageQueue, extensionsManager);
        uiMessageManager = new UIMessageManager(theMessageQueue, extensionsManager);
    }

    /**
     * register registers the ui framework observer with the platform to receive messages
     * 
    ...
    /**
     * start kicks off all the threads
     * 
